...
function Doing(props){
  ...
  function drop(event) {
    ...
    let draggedObject = props.archiveNoteList.filter(object => {return object.noteId == data})
    ...
    if (draggedObject.length == 0){
      ...
      draggedObject = props.archiveNoteList.filter(object => { return object.noteId == data})
